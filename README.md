...
# Execução de Autómatos Finitos

<table>
<tr>
<td>

> Considere um autómato A, eventualmente com transições ϵ. Mais formalmente, sejam Σ um
alfabeto, S um conjunto de estados, S0 e F dois subconjuntos de S (respetivamente conjunto de
estados iniciais e conjunto de estados finais) e Rδ uma relação de transição sobre Σ e S. Temos
assim A = {Σ ∪ {ϵ}, S, S0, F,Rδ}.
...
> No caso em que tiver que optar entre 2 estados para continuar a execução, deverá sempre optar
pelo estado de índice mais baixo.
...
[![Nelson Fortuna](https://cdn.discordapp.com/attachments/1050105332891926569/1136347325686620384/Sem_titulo2.png)](https://pt.linkedin.com/in/nelson-fortuna/en)| [![Tiago Barreiros](https://avatars.githubusercontent.com/u/78179371?s=100&v=4)](https://github.com/tiago-barreiros)
---|----------------------------------------------------------------------------------------------------------------------
[Nelson Fortuna](https://pt.linkedin.com/in/nelson-fortuna/en)|[Tiago Barreiros](https://github.com/tiago-barreiros)

# Orientação

## [Prof. Doutor Simão Melo de Sousa](https://www.di.ubi.pt/~desousa/)

## [Prof. Luís Horta](https://www.ubi.pt/Pessoa/luis.horta)

## *Teoria da Computação* @[Universidade da Beira Interior](https://www.ubi.pt/).
